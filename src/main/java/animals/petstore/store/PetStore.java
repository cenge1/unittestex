...
public class PetStore
{
    ...
    public void init()
    {
        ...
        this.addPetInventoryItem(new Snake(AnimalType.DOMESTIC, Skin.SCALES, Gender.MALE, Breed.MILK,
                new BigDecimal("100.00"),2));
        this.addPetInventoryItem(new Snake(AnimalType.DOMESTIC, Skin.SCALES, Gender.MALE, Breed.CORAL,
     ...
     */
    private Snake identifySoldSnakeFromInventory(Snake soldSnake) throws DuplicatePetStoreRecordException, PetNotFoundSaleException {
